...
// //         <h2 className="text-3xl font-semibold text-gray-800 mb-6">Disclaimer</h2>
// //         <p className="text-gray-600 mb-4">
// //           By using Vercast Video, you acknowledge that videos uploaded may be removed without user consent if they are reported for inappropriate content or violate the platform's terms of service.
// //         </p>
// //         <p className="text-gray-600 mb-4">
// //           Users can report videos by contacting us through the "Contact Us" page.
// //         </p>
// //       </div>
// //     </div>
// //   );
...
//         The information provided by Vercast Video is for general informational purposes only. 
//         All content on this platform is uploaded by users, and Vercast Video does not verify 
...
//       <p className="text-gray-700 mb-4">
//         - Vercast Video does not take responsibility for user-uploaded content.<br />
...
//       <p className="text-gray-700 mb-4">
//         - By using Vercast Video, you acknowledge that videos uploaded may be removed without user consent if they are reported for inappropriate content or violate the platform's terms of service.<br />
...
//         - Vercast Video is not responsible for any content uploaded unless it has been reported for review and found to be in violation of platform policies.<br />
...
//       <p className="text-gray-700 mb-4">
//         - Vercast Video may contain links to third-party websites. We do not control or endorse the content of these external sites and are not responsible for any damages or issues that may arise from accessing them.
//       </p>

//       <h2 className="text-2xl font-semibold mt-6 mb-2">4. Platform Availability</h2>
//       <p className="text-gray-700 mb-4">
//         - While we strive to provide an uninterrupted experience, Vercast Video does not guarantee constant availability or error-free functionality.<br />
...
//         <span className="font-semibold">Email:</span> drtrailer2022@gmail.com
//       </p>
//     </div>
//   );
// }
